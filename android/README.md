...
```gradle
dependencies {
    implementation 'com.github.apiverve:lovecalculator-api:1.1.13'
}
```
...
```java
import com.apiverve.lovecalculator.LoveCalculatorAPIClient;
import com.apiverve.lovecalculator.APIResponse;
import com.apiverve.lovecalculator.APIException;

// Initialize the client
LoveCalculatorAPIClient client = new LoveCalculatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("name1", "John");
    parameters.put("name2", "Jane");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/lovecalculator](https://docs.apiverve.com/ref/lovecalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/lovecalculator](https://docs.apiverve.com/ref/lovecalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/lovecalculator-api/issues)
