...
{
    class LoveCalculatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/lovecalculator";

        /// <summary>
        /// Make a GET request to the Love Calculator API
        /// </summary>
        static async Task<JsonDocument> CallLoveCalculatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;name1&quot;] &#x3D; &quot;John&quot;, [&quot;name2&quot;] &#x3D; &quot;Jane&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Love Calculator API...\n");

            var result = await CallLoveCalculatorAPI();
