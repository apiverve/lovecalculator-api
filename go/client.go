...
const (
	baseURL        = "https://api.apiverve.com/v1/lovecalculator"
	defaultTimeout = 30 * time.Second
)

// Client is the Love Calculator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Love Calculator API client.
...
// Execute makes a request to the Love Calculator API with typed parameters.
//
