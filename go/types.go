// Package lovecalculator provides a Go client for the Love Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/lovecalculator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Love Calculator API.
//
// Parameters:
//   - name1 (required): string - The first name to calculate love compatibility
//   - name2 (required): string - The second name to calculate love compatibility
type Request struct {
	Name1 string `json:"name1"` // Required
	Name2 string `json:"name2"` // Required
}
...
// ResponseData contains the data returned by the Love Calculator API.
type ResponseData struct {
	Name1 string `json:"name1"`
	Name2 string `json:"name2"`
	LovePercentage string `json:"lovePercentage"`
