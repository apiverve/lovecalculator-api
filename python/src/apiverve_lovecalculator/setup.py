...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/lovecalculator',
        'Source': 'https://github.com/apiverve/lovecalculator-api',
        'Bug Tracker': 'https://github.com/apiverve/lovecalculator-api/issues'
    },
    classifiers=[
