...
class lovecalculatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/lovecalculator');
        }
        ...
        this.validationRules = {"name1":{"type":"string","required":true},"name2":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/lovecalculator`);
        }
    }
...
module.exports = lovecalculatorWrapper;
