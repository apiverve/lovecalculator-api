...
namespace APIVerve\Lovecalculator;
...
/**
 * Client for the Love Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/lovecalculator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/lovecalculator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LovecalculatorClient] {$message}\n";
        }
    }
}
